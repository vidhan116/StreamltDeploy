...
if st.session_state.logged_in:
    ...
    if project== 'AirBus':
        ...
        file_path = "Employee master/AirBus bridge file.xlsx"
        file_name = "AirBus bridge file.xlsx"
    ...
    if project== 'FORD':
        # Path to the Excel file
        file_path = "Employee master/Ford Client Details.xlsx"
        file_name = "Ford bridge file.xlsx"
    ...
    if project== 'ICON':
        # Path to the Excel file
        file_path = "Employee master/ICON bridge file.xlsx"
        file_name = "ICON bridge file.xlsx"
    ...
    if project == 'FORD':
        ...
        if project_bridge_file and timesheet_files:
            try:
                ...
                Ford_result_Download = st.download_button("Generate Ford result file",
    ...
    Output_FormattedButton = st.sidebar.button('Download Output Result')
    ...
    #         #                                           open('OutputResultFolder/Ford_Outputfile.csv', 'rb').read(),
    #         #                                           file_name='Ford_Outputfile.csv', mime='text/csv')
    #         # if Ford_result_Download:
    #         #     st.success("Ford result file has been downloaded")
    #         ##++++++++++++++++++++++++++++++++++++++++++++++++++AIRBUS+++++++++++++++++++++++++++++++++++++++++
    #
    ...
    #         #     data=open('OutputResultFolder/AirBus_Outputfile.csv', 'rb').read(),
    #         #     file_name='AirBus_result.csv',
    #         #     mime='text/csv'
    #         # )
    #         # if AirBus_result_download:
    ...
    #         #     data=open('OutputResultFolder/ICON_Outputfile.csv', 'rb').read(),
    #         #     file_name='ICON_result.csv',
    #         #     mime='text/csv'
    #         # )
    #         # if ICON_result_download:
    ...
    #
        ...
        ("*Note: Post generate files Click Download Output Result button.")
